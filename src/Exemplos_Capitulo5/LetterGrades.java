...
public class LetterGrades {
    public static void main(String[] args) {
        ...
        System.out.printf("%s%n%s%n  %s%n  %s%n",
                ...
                "Type the end-of-while indicator to terminate input:",
        ...
        while (input.hasNext()) {
            ...
            total += grade; // adiciona total a nota
            ++gradeCounter; // incrementa o número de notas

            // incrementa o contador de letras a nota adequada
            switch (grade / 10) {
