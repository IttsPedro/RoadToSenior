...
public class GradeBook2 {
    ...
    public void processGrades() {
        ...
        System.out.printf("%n%s  %d%n%s  %d%n%n", "Lowest grade in the grade book is", getMinimum(),
                "Highest grade in the garde book is", getMaximum());
    ...
    public int getMaximum() {
        ...
        // supõe que o primeiro elemento de array de notas é maior
    ...
    // gera saída do gráfico de barras para exibir distruibuição total de notas
    public void outputBarChart() {
        ...
        // para cada nota em GradeBook, incrementar a frequência apropriada
        for (int[] studentGrades : grades) {
    ...
    public void outputGrades() {
        ...
        System.out.println("Average"); // título da coluna média do aluno
