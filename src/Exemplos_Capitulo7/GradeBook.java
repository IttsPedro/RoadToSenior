...
// classe GradeBook utilizando um array para armazenar notas de test.
...
public class GradeBook {
    ...
    public int getMinimum() {
        ...
        int lowGrade = grades[0]; // supões que grade[0] é menor nota
    ...
    public int getMaximum() {
        ...
        for (int grade : grades) {
            ...
            // se a nota que highGrade, atribui essa nota a highGrade
            if (grade > highGrade)
    ...
    public void outputGrades() {
        ...
        for (int student = 0; student < grades.length; student++)
            System.out.printf("Students %2d: %3d%n", student + 1, grades[student]);
    }
