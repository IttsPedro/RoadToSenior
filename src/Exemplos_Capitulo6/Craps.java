package Exemplos_Capitulo6;
// Figura 6.8: Craps.java
// Aclasse Craps simula o jogo de dados craps
...
public class Craps {
    ...
    public static void main(String[] args) {
        ...
        int myPoints = 0; // pontos se não ganhar ou perder na 1ª rolagem
        Status gameStatus; // para conter CONTINUE, WON ou LOST
        ...
        switch (sumOfDice) {
            ...
            default: // não ganhou nem perdeu, portanto, registra a pontuação
                ...
                myPoints = sumOfDice; // informa a pontuação
                System.out.printf("Points is %d%n", myPoints);
                break;
        }
        ...
        while (gameStatus == Status.CONTINUE) { // nem WON nem LOST
            ...
            if (sumOfDice == myPoints) // vitória por pontuação
                gameStatus = Status.WON;
    ...
    // exibe uma mensagem, calcula a soma e exibe os resultados
    public static int rollDice() {
        ...
        // exibe os resultados desses lançamentos
